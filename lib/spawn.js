...
function spawn(phantomJsConfig) {
    ...
    /**
     * Step 1: Start phantomjs with the config path and pipe stderr and stdout.
     */
            return when.promise(function (resolve, reject) {
                ...
                var runOptions = [];
                for (var k in phantomJsConfig) {
                    runOptions.push("--" + paramCase(k) + "=" + phantomJsConfig[k]);
                }
                runOptions.push(startScript);
                child = childProcess.spawn(phantomjs.path, runOptions);
    ...
    /**
     * Step 2: Create the actual Phantom-instance and return it.
     */
        .then(function () {
